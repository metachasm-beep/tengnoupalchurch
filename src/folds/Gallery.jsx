...
export default function Gallery({ galleryImages }) {
  ...
  return (
    <section id="gallery" className="w-full flex flex-col justify-center bg-forest-800 py-32">
      <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
        <h2 className="font-serif text-4xl font-medium tracking-tight text-bone-50">Community & Construction</h2>
      </div>
